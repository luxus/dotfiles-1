...
return {uu.tx("clojure-vim/vim-jack-in", {ft = "clojure", cmd = "Clj", lazy = true}), uu.tx("tpope/vim-dispatch", {lazy = false}), uu.tx("williamboman/mason-lspconfig.nvim", {opts = _1_}), uu.tx("nvim-treesitter/nvim-treesitter", {opts = _2_}), uu.tx("Olical/conjure", {dev = dev_3f, init = _3_}), uu.tx("Olical/AnsiEsc"), uu.tx("PaterJason/cmp-conjure")}
